...
public class SharePrefrences {
    ...
    public SharePrefrences(AppWear obj) {
        this.appObj = obj;
    }
    ...
    public void setBooleanPref(String key, boolean val) {
        SharedPreferences.Editor pref = appObj.getSharedPreferences(
                appObj.PREF_NAME, Context.MODE_PRIVATE).edit();
        pref.putBoolean(key, val);
        pref.commit();
    ...
    public float getFloatPref(String key) {
        SharedPreferences pref = appObj.getSharedPreferences(appObj.PREF_NAME, Context.MODE_PRIVATE);
